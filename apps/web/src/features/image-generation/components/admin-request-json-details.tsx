            ...
            {snapshot && formattedJson ? (
              <div className="space-y-2">
                <p className="break-all font-mono text-[10px] text-muted-foreground">
                  {snapshot.operation} · {snapshot.contentType}
                </p>
                <pre className="max-h-96 overflow-auto rounded-sm bg-background p-3 text-left font-mono text-[11px] leading-relaxed text-foreground ring-1 ring-border">
