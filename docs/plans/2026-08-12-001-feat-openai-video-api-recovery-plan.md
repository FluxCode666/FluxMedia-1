...
- **Files:**
  ...
  - `packages/database/drizzle/0087_video_submission_retry.sql`
...
| Migration | `pnpm --filter @repo/integration-tests exec vitest run src/video-submission-retry-migration.test.ts` | `0087` 可重入、尝试唯一约束、历史完整/不完整任务分流 |
